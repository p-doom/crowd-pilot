...
def to_nemo_jsonl(cfg: SerializeConfig) -> None:
    ...
    def _print_turn_stats(label: str, values: List[int]) -> None:
        ...
        print(
            ...
            f"count={count}, median_turns={median:.1f}, avg_turns={avg:.1f}, "
            f"min_turns={min_len}, max_turns={max_len}"
        )
    ...
    def _print_char_stats(label: str, values: List[int]) -> None:
        ...
        print(
            ...
            f"count={count}, median_chars={median:.1f}, avg_chars={avg:.1f}, "
            f"min_chars={min_len}, max_chars={max_len}"
        )
